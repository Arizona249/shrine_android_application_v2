package com.example.ArinzeCommerce_v2;
...
import com.example.ArinzeCommerce_v2.staggeredgridlayout.StaggeredProductCardRecyclerViewAdapter;
...
public class ProductGridFragment extends Fragment {
    ...
    public View onCreateView(
        ...
        int largePadding = getResources()
                .getDimensionPixelSize(R.dimen.staggered_product_grid_spacing_large);

        int smallPadding = getResources()
                .getDimensionPixelSize(R.dimen.staggered_product_grid_spacing_small);
    ...
    private void setUpToolbar(View view) {
        ...
        toolbar.setNavigationOnClickListener(
                new NavigationIconClickListener(
                        ...
                        ContextCompat.getDrawable(requireContext(), R.drawable.branded_menu),
