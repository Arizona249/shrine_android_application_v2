package com.example.jetcommerce_v1.network;
...
import com.example.jetcommerce_v1.application.JetBreedApplication;
...
public class ImageRequester {
    ...
    public static synchronized ImageRequester getInstance() {
        if (instance == null) {
            Context context = JetBreedApplication.getAppContext();
            if (context == null) {
